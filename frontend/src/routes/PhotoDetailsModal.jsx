...
const PhotoDetailsModal = ({ photo, openModal, closeModal, favourites, favouritesTracker }) => {
      ...
      <button className="photo-details-modal__close-button" onClick={handleClick} >
        ...
        <div className="photo-details-modal__images">
          ...
          <div className="photo-details-modal__header">
            Similar Photos
            <div className="photo-details-modal__images">
              <PhotoList photos={Object.values(photo.similar_photos)} favouritesTracker={favouritesTracker} favourites={favourites} openModal={openModal} />
            </div>
          </div>
        </div>
